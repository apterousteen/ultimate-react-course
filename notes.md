...
Обновляется state → дерево компонентов → React Element в виртуальном DOM, вместе с ним реренлерятся и его потомки, тк
...
Далее в процессе сверки и diffing (сравнение элементов на основании позиции в дереве) VDOM и Fiber tree будет создано
